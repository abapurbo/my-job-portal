            ...
            <div className='m-10 '>
                <div className='text-center space-y-5 '>
                    ...
                    {/* <div className='flex  space-x-4'>
                        <div className=' border-1 rounded-xl p-6 hover:scale-105 flex flex-col justify-start items-start duration-700'>
                            <img src={marketing} className='w-10' alt='this is category image' />
                            <h1 className='font-bold text-xl'>Marketing & Sale</h1>
                            <span className='text-[15px] font-semibold'>1543 jobs Available</span>
                        </div>
                        ...
                        <div className=' border-1 rounded-xl p-4 h-26 space-x-4 hover:scale-105 flex justify-start  items-center h duration-700' >
                            <img src={finance} className='w-10' alt='this is category image' />
                            <div className='flex flex-col justify-start items-start'>
                                <h1 className='text-xl font-bold '>Finance</h1>
                                <span className='font-semibold text-[15px]'>185 jobs Available</span>
                        ...
                        <div className=' border-1 rounded-xl p-4 hover:scale-105 flex flex-col justify-start items-start duration-700' >
                            <img src={user} className='w-10' alt='this is category image' />
                        </div>

                        <div className=' border-1 rounded-xl p-4 hover:scale-105 flex flex-col justify-start items-start duration-700' >
                            <img src={management} className='w-10' alt='this is category image' />
                        </div>

                        <div className=' border-1 rounded-xl p-4 hover:scale-105 flex flex-col justify-start items-start duration-700' >
                            <img src={product} className='w-10' alt='this is category image' />
                        </div>

                        <div className=' border-1 rounded-xl p-4 hover:scale-105 flex flex-col justify-start items-start duration-700' >
                            <img src={research} className='w-10' alt='this is category image' />
                        </div>
                    </div> */}
